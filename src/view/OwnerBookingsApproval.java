...
public OwnerBookingsApproval(HouseController controller) {
    initComponents();
    ...
    private void initComponents() {
        ...
        Booking_Requests.add(JScrollPane);

        getContentPane().add(Booking_Requests);
        Booking_Requests.setBounds(50, 160, 220, 160);
 ...
 public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(() -> {
        ...
        new OwnerBookingsApproval(controller).setVisible(true);
    });
 }
